...
export const Hero = () => {
  return (
    <div className="w-full h-[calc(100vh-80px)] bg-cover   bg-[url(/hero-abstract.jpg)] relative flex items-center flex-col justify-start text-white">
      ...
      <Header />
      <div className="relative z-20 h-full flex flex-col items-center justify-center max-w-lg  space-y-4 px-4">
        <h1 className="text-4xl font-medium text-center text-background">
          This is Favor Eliab. A frontend web developer
        </h1>
        <p className="text-base w-full text-center text-muted">
        ...
        <div className="space-x-4 flex">
          <Button className="rounded-xs" variant={'secondary'} size={'lg'}>
            Contact Me
          </Button>
